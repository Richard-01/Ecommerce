                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Detalles ventas</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($detalleventas as $ventas) {  ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="sparkbar" data-color="#00a65a" data-height="50"><?php echo $ventas['PrecioUnitario'] ?></div>
                                                        </td>
                                                        <td><?php echo $ventas['total'] ?></td>

                                                    </tr>
                                                    
                                                    <?php $total = $total + ($ventas['total']); ?>
                                                <?php } ?>
                                                <tr>
                                                    <td></td>
                                                    <td></td>
