    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown user-menu">
        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" >
          <img src="img/imagenes_admins/<?php foreach($listaadmin as $admin){ if ($_SESSION['usuario']==$admin['usuario']){ echo $admin['foto'];}}?>" class="user-image img-circle elevation-2" alt="User Image">
        ...
        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <li class="user-footer">
            ...
            <a href="../Loginn/logout.php" class="btn btn-default btn-flat float-right">cerrar sesion</a>            
          </li>
        </ul>
      </li>
