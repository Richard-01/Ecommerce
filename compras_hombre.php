...
<section class="content">
  <div class="container-fluid">
    ...
    <div class="card-header bg-white border-transparent col-md-12">
      <h2>categorias:</h2>
       <button class="boton"><a class="aboton" href="hombres.php">hombres</a></button> 
       <button class="boton"><a class="aboton" href="mujeres.php">mujeres</a></button>
       <button class="boton"><a class="aboton" href="accesorios.php">accesorios</a></button>
       <br><br>
      ...
      foreach ($listaproducto as $producto) {
        if ($producto['estado'] == 'activo') {  ?>
          <div class="col-lg-3 col-6">
            <div class="card">
              <img id="myImg" class="img-thumbnail" width="300px"  src="admin_tienda/img/imagenes_cart/<?php echo $producto['foto']; ?>" data-toggle="popover" data-trigger="hover" data-content="<?php echo $producto['descripcion']; ?>">
              <div class="card-body">
    ...
    <div class="modal-content"><a href="#" onclick="Resetpage()" data-dismiss="modal" class="rbm_btn_x_out_shtr rbm_sldr_cmrce_close">close</a>
      <div class="row">
        ...
        <form action="" method="post" enctype="multipart/form-data">
          ...
          <input type="hidden" name="txtid_producto" value="<?php echo $producto['id_producto']; ?>">
          <input type="hidden" name="foto" id="foto" value="<?php echo $txtfoto; ?>">
...
<script>
  function Resetpage() {
    window.location.replace("compras_hombre.php");
